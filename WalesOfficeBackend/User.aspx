...
<body>
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txtFirstName" runat="server" style="z-index: 1; left: 162px; top: 75px; position: absolute; width: 142px"></asp:TextBox>
        <asp:TextBox ID="txtSecondName" runat="server" style="z-index: 1; left: 161px; top: 121px; position: absolute; width: 142px"></asp:TextBox>
        <asp:TextBox ID="txtAddress" runat="server" style="z-index: 1; left: 161px; top: 165px; position: absolute; width: 143px"></asp:TextBox>
        <asp:TextBox ID="txtDOB" runat="server" style="z-index: 1; left: 161px; top: 209px; position: absolute; width: 141px"></asp:TextBox>
        ...
        <asp:DropDownList ID="ddlRole" runat="server" style="z-index: 1; left: 530px; top: 120px; position: absolute; height: 21px; width: 112px">
        </asp:DropDownList>
