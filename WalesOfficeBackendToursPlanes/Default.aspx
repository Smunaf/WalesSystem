...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ListBox ID="lstTours" runat="server" style="z-index: 1; left: 51px; top: 80px; position: absolute; height: 212px; width: 375px; bottom: 372px"></asp:ListBox>
        <br />
        <br />
        <br />
        <br />
        <asp:Label ID="lblFirstName" runat="server" style="z-index: 1; left: 52px; top: 305px; position: absolute" Text="Please Enter the Tour Name here:"></asp:Label>
        <asp:TextBox ID="txtTourName" runat="server" style="z-index: 1; left: 53px; top: 336px; position: absolute; width: 263px"></asp:TextBox>
        <p>
